 ...
 * El juego se dará por ganado cuando se termina el dí­a y se consiguieron las monedas necesarias.
 * Se dará por perdido si se termina el dí­a y no se llegó al monto.
 */
int estado_juego(juego_t juego);


/* Pre condiciones: Los campos `platos_preparacion ` y `platos_listos ` del campo `cocina ` del juego
